...
export default function TestPage() {
  ...
  const messages = [
    "Chargement de l'IA...", "Loading AI Core...",
    "Initialisation du système...", "System Initialization...",
    "Connexion aux serveurs...", "Connecting to servers...",
    "Optimisation des ressources...", "Optimizing resources...",
    "Vérification de sécurité...", "Security Check...",
    "Carga de IA...", "Carga de recursos...",
    "Bienvenue sur CStream", "Welcome to CStream"
  ];
  ...
  return (
    <div className="min-h-screen bg-[#050507] text-white flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8">
        <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
          Zone de Test : Animation
        </h1>
        <p className="text-white/60 text-lg max-w-2xl mx-auto">
          Cliquez ci-dessous pour lancer l'animation de chargement complète en overlay.
          <br />Elle tournera en boucle jusqu'à ce que vous la fermiez.
        </p>

        <Button
          onClick={() => setShowOverlay(true)}
          className="h-20 px-12 rounded-full bg-white text-black hover:scale-105 transition-transform text-xl font-black uppercase tracking-widest shadow-[0_0_50px_rgba(255,255,255,0.3)]"
        >
      ...
      <AnimatePresence>
        {showOverlay && (
          ...
          >
            ...
            >
              <X className="w-6 h-6 mr-2" /> Fermer le Test
            </Button>

            {/* REPLICATED FROM INDEX.HTML */}
            <div className="loader-content scale-150">
              ...
              {/* Localized Text */}
              <div className="loader-messages" style={{ opacity: 1 }}>
            ...
            <style jsx global>{`
              ...
              .loader-progress-bar {
                ...
                width: 0%;
                animation: progressFill 6s cubic-bezier(0.22, 1, 0.36, 1) forwards, gradientMove 2s linear infinite;
              ...
              .logo-path {
                ...
                animation:
                  ...
                  fill 1.5s ease-in-out 3.5s forwards,
                  pulse-logo 4s ease-in-out 5s infinite;
              }
              ...
              @keyframes fill {
                to { fill: url(#logoGradient); stroke-width: 0; }
              }
              ...
              @keyframes pulse-logo {
                0%, 100% { transform: scale(1); filter: drop-shadow(0 0 30px rgba(139, 92, 246, 0.3)); }
                50% { transform: scale(1.03); filter: drop-shadow(0 0 60px rgba(139, 92, 246, 0.6)); }
              }
